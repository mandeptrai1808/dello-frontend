      ...
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        >
          ...
          onChange: (value) => {
            ...
            <div className="flex">
              <div className="h-20 w-20 m-2 mr-5  rounded-full overflow-hidden">
                <img
                  src={userData.avatar}
                  alt="avt"
          ...
          onChange: (value) => {
            ...
            <div className="py-2">
              <button className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full" onClick={()=>{
                dispatch({type:"OPEN_MODAL", content: <EditUser/>})
              }}>
                Upload Avatar
              </button>
            </div>
            <p className="pt-8 text-sm">
              Đây là một trong những người dùng dễ thương nhất của chúng tôi!
            </p>
